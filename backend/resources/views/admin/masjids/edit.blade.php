        ...
        <div class="form-grid">
            ...
            <div class="field full">
                ...
                <div style="margin-top:12px">
                    <img id="donation_qr_preview" src="{{ $masjid->donation_qr_image ? Storage::disk('public')->url($masjid->donation_qr_image) : '' }}" alt="Donation QR image preview" style="{{ $masjid->donation_qr_image ? '' : 'display:none;' }}width:min(240px,100%);aspect-ratio:1;object-fit:contain;border-radius:14px;border:1px solid #d1d5db;background:#fff;padding:8px">
                </div>
                @if($masjid->donation_qr_image)
